    ...
    (() => {
            ...
            window.addEventListener("load", (function(e) {
                ...
                function getHeight(showMoreBlock, showMoreContent) {
                    ...
                    if ("items" === showMoreType) {
                        ...
                        const showMoreTypeValue = showMoreContent.dataset.showmoreContent ? showMoreContent.dataset.showmoreContent : 443;
        ...
        function initSliders() {
            if (document.querySelector(".slider-main")) new core(".slider-main", {
                ...
                navigation: {
                    prevEl: ".main-arrows .main-arrows_prev",
                    nextEl: ".main-arrows .main-arrows_next"
                },
                on: {}
            });
            if (document.querySelector(".add-main__slider")) new core(".add-main__slider", {
                ...
                pagination: {
                    el: ".controls-slider-add__dotts",
                    clickable: true
                },
                navigation: {
                    prevEl: ".add-arrows .add-arrows_prev",
                    nextEl: ".add-arrows .add-arrows_next"
                },
                on: {}
            });
            if (document.querySelector(".slider-catalog")) new core(".slider-catalog", {
                ...
                speed: 500,
                navigation: {
                    prevEl: ".catalog-arrows .catalog-arrow_prev",
                    nextEl: ".catalog-arrows .catalog-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".slider-card")) new core(".slider-card", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 500,
                pagination: {
                    el: ".card-slide__dotts",
                    clickable: true
                },
                on: {}
            });
            if (document.querySelector(".slider-passage")) new core(".slider-passage", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                speed: 500,
                navigation: {
                    prevEl: ".passage-arrows .passage-arrow_prev",
                    nextEl: ".passage-arrows .passage-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".slider-category")) new core(".slider-category", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                parallax: true,
                pagination: {
                    el: ".slider-category__dotts",
                    clickable: true
                },
                on: {}
            });
            if (document.querySelector(".images-product__thubs")) {
                const thumbsSwiper = new core(".images-product__thubs", {
            ...
            if (document.querySelector(".slider-steps")) new core(".slider-steps", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                speed: 500,
                navigation: {
                    prevEl: ".steps-arrows .steps-arrow_prev",
                    nextEl: ".steps-arrows .steps-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
...
***************************************************************************** */
        ...
        const cartMenu = document.querySelector(".menu-cart__body");
        const cartContent = document.querySelector(".menu-cart__content");
        const cartBtnClose = document.querySelector(".menu-cart__close");
        if (cartBtn) cartBtn.addEventListener("click", (() => {
            cartMenu.classList.add("menu-cart-open");
            cartContent.classList.add("content-cart-open");
        }));
        if (cartBtnClose) cartBtnClose.addEventListener("click", (() => {
            cartMenu.classList.remove("menu-cart-open");
            cartContent.classList.remove("content-cart-open");
        }));
        if (cartMenu) cartMenu.addEventListener("click", (() => {
            cartMenu.classList.remove("menu-cart-open");
            cartContent.classList.remove("content-cart-open");
        }));
        const catalogBtn = document.querySelector(".catalog-fixed__button");
        const catalogBtnClose = document.querySelector(".cover-catalog__close");
        const catalogMenu = document.querySelector(".catalog-fixed__cover");
        if (catalogBtn) catalogBtn.addEventListener("click", (() => {
            catalogMenu.classList.add("cover-catalog-open");
        }));
        if (catalogBtnClose) catalogBtnClose.addEventListener("click", (() => {
            catalogMenu.classList.remove("cover-catalog-open");
        }));
        const itemCoverMenu = document.querySelector(".cover-item__menu");
        const itemCoverBtn = document.querySelector(".cover-catalog__for");
        const itemCoverBack = document.querySelector(".cover-item__back");
        if (itemCoverBtn) itemCoverBtn.addEventListener("click", (() => {
            itemCoverMenu.classList.add("item-menu-open");
        }));
        if (itemCoverBack) itemCoverBack.addEventListener("click", (() => {
            itemCoverMenu.classList.remove("item-menu-open");
        }));
        const categoryEye = document.querySelector(".slider-category__eye");
        const categoryCover = document.querySelector(".slider-category__cover");
        if (categoryEye) categoryEye.addEventListener("click", (function() {
            categoryCover.classList.toggle("category-cover-open");
            categoryEye.classList.toggle("eye-open");
        }));
        const productBtnLong = document.querySelectorAll(".info-product__long");
        for (var i = 0; i < productBtnLong.length; i++) productBtnLong[i].addEventListener("click", (function() {
            var current = document.getElementsByClassName("info-long-active");
            current[0].className = current[0].className.replace(" info-long-active", "");
            this.className += " info-long-active";
        }));
        const productBtnPakage = document.querySelectorAll(".info-product__package");
        for (i = 0; i < productBtnPakage.length; i++) productBtnPakage[i].addEventListener("click", (function() {
            var current = document.getElementsByClassName("info-package-active");
            current[0].className = current[0].className.replace(" info-package-active", "");
            this.className += " info-package-active";
        }));
        const productBtnGrass = document.querySelectorAll(".info-product__grass");
        for (i = 0; i < productBtnGrass.length; i++) productBtnGrass[i].addEventListener("click", (function() {
            var current = document.getElementsByClassName("info-grass-active");
            current[0].className = current[0].className.replace(" info-grass-active", "");
            this.className += " info-grass-active";
        }));
        const stepsBtn = document.querySelectorAll(".first-steps__button");
        for (i = 0; i < stepsBtn.length; i++) stepsBtn[i].addEventListener("click", (function() {
            var stepsBtnActive = document.getElementsByClassName("steps-btn-active");
            stepsBtnActive[0].className = stepsBtnActive[0].className.replace(" steps-btn-active", "");
            this.className += " steps-btn-active";
        }));
        const calendareDateSteps = document.querySelectorAll(".calendar-times__date");
        for (i = 0; i < calendareDateSteps.length; i++) calendareDateSteps[i].addEventListener("click", (function() {
            var calendareDateActive = document.getElementsByClassName("date-calendar-active");
            calendareDateActive[0].className = calendareDateActive[0].className.replace(" date-calendar-active", "");
            this.className += " date-calendar-active";
        }));
        const calendarBtnOpen = document.querySelector(".times-steps-third__clndrBtn");
        const calendarList = document.querySelector(".times-steps-third__calendar");
        if (calendarBtnOpen) calendarBtnOpen.addEventListener("click", (() => {
            calendarList.classList.toggle("calendar-times-open");
        }));
        const clockBtn = document.querySelector(".times-steps-third__clkBtn");
        const clockList = document.querySelector(".times-steps-third__clock");
        const clockListItem = document.querySelectorAll(".clock-times__item");
        if (clockBtn) clockBtn.addEventListener("click", (() => {
            clockList.classList.toggle("clock-times-open");
        }));
        if (clockListItem) [ clockListItem.forEach((element => {
            element.addEventListener("click", (() => {
                clockList.classList.remove("clock-times-open");
            }));
        })) ];
        window["FLS"] = true;
        isWebp();
